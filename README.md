...
| Fixed-goal red cube, 100 identical scenes | oracle 100/100, modular 90/100, ACT (LeRobot, scripted demos) 55/100 with 240 demos at 192 px and 25k steps; a third attempt with 700 demos, a cropped view and start-pose jitter placed 47/100 at 30k steps (under-trained, still rising); the first attempt (120 demos, 128 px) placed 6/100 and was diagnosed as a 1-3 cm lateral offset at the grasp that the fixed-jaw executor cannot absorb, see `docs/ACT.md` |
